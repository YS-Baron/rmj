...
<head>
    ...
    <title>龙岗中心城万科天誉二期朝南主卧合租租房价格信息_深圳龙岗区租房价格信息-如美家</title>
    <!--    <link rel="icon" href="/favicon.ico" type="image/x-icon" />-->
    <!--    <meta name="keywords" content="深圳租房,深圳合租,万科天誉二期租房,龙岗区租房,龙岗中心城租房">-->
    <!--    <meta name="description" content="深圳自如网,为租客在龙岗区龙岗中心城万科天誉二期找到了合租住房,该房源的付款方式为押一付三,月租房价格非常便宜且无中介费,更多有在龙岗中心城万科天誉二期的合租房源尽在深圳自如网。">-->
    ...
    <!--    <meta name="csrf-token" content="LWlZamZxM0NnDzVZJxULcBsfLwU.SVtzTBwKEy4EQRB9JSNdUgJHCw==">-->
...
<script type="text/javascript">var ZRCONFIG = {"CSS_DOMAIN":"http://static8.ziroom.com/","JS_DOMAIN":"http://static8.ziroom.com/","DOMAIN":"http://sz.ziroom.com","ENV":"","room_id":"61719337","is_whole":0,"house_id":"60273671","house_type":"1","resblock_id":"2420026296315922","city_code":"440300","resblock_name":"万科天誉二期","is_turn":0,"resblockPosition":[114.251789,22.717501]};</script><body>
<!-- Header  头部 -->
...
<section class="Z_container Z_main">
    ...
    <section class="Z_info_main">
            ...
            <div class="Z_sliders">
                ...
                <ul>
                    <li class="Z_slider" data-type="image" data-t="图片">
                        <img src="images/img1/house2.1.jpg"alt="龙岗中心城万科天誉二期合租房源" >
                    </li>
                    <li class="Z_slider" data-type="image" data-t="图片">
                        <img src="images/img1/house2.2.jpg"alt="龙岗中心城万科天誉二期合租房源" >
                    </li>
                    <li class="Z_slider" data-type="image" data-t="图片">
                        <img src="images/img1/house2.3.jpg"alt="龙岗中心城万科天誉二期合租房源" >
                    </li>

                    <li class="Z_slider" data-type="image" data-t="图片">
                        <img src="images/img1/house2.4.jpg" alt="龙岗中心城万科天誉二期合租房源" >
                    </li>
                    <li class="Z_slider" data-type="image" data-t="图片">
                        <img src="images/img1/house2.5.jpg" alt="龙岗中心城万科天誉二期合租房源" >
                    </li>
                    <li class="Z_slider" data-type="image" data-t="图片">
                        <img src="images/img1/house2.6.jpg" alt="龙岗中心城万科天誉二期合租房源" >
                    </li>
                    <li class="Z_slider" data-type="image" data-t="图片">
                        <img src="images/img1/house2.7.jpg" alt="龙岗中心城万科天誉二期合租房源" >
                    </li>
                    <li class="Z_slider" data-type="image" data-t="图片">
                        <img src="images/img1/house2.8.jpg" alt="龙岗中心城万科天誉二期合租房源" >
                    </li>

                    <li class="Z_slider" data-type="image" data-t="户型">
                        <img src="images/img1/house2.9.jpg" alt="龙岗中心城万科天誉二期合租房源户型图" >
                    </li>
                </ul>
            ...
            <div class="Z_swiper_thumb">
                ...
                <ul class="Z_swiper_thumb_inner Z_sliders_nav">
                    <li class="" data-index="0">
                        <img src="images/img1/house2.1.jpg">
                    </li>
                    <li class="" data-index="1">
                        <img src="images/img1/house2.2.jpg">
                    </li>
                    <li class="" data-index="2">
                        <img src="images/img1/house2.3.jpg">
                    </li>

                    <li class="" data-index="3">
                        <img src="images/img1/house2.4.jpg">
                    </li>
                    <li class="" data-index="4">
                        <img src="images/img1/house2.5.jpg">
                    </li>
                    <li class="" data-index="5">
                        <img src="images/img1/house2.6.jpg">
                    </li>
                    <li class="" data-index="6">
                        <img src="images/img1/house2.7.jpg">
                    </li>
                    <li class="" data-index="7">
                        <img src="images/img1/house2.8.jpg">
                    </li>


                    <li class="" data-index="8">
                        <img src="images/img1/house2.9.jpg">
                    </li>
                </ul>
        ...
        <div class="Z_page_navs_base">
            <div id="Z_page_nav" class="Z_page_nav">
                ...
                <ul class="clearfix Z_page_navs">
                    ...
                    <li data-id="villageinfo"><a href="javascript:void(0)"  nofllow>小区简介</a></li>
        ...
        <div class="Z_isection scrollid" id="homedesc">
            ...
            <p class="house_sourcecode mt10">编号  SZZRGY0818295276_01</p>
            <div class="Z_rent_desc">
                房子是4.0风格，独立卫生间，配备实木大衣柜，收纳性很好，非常适合2个人居住。房子带落地大窗，让您享受每一缕阳光；宽敞明亮空间大，视野很棒！                </div>
            <div class="hidehomedesc">房源位于深圳龙岗区龙岗中心城万科天誉二期,房源户型为4室1厅, 共有4个房间。当前房间可入住时间为随时入住,此房间拥有拿铁4.0、独立卫生间、短租、智能锁、非首次出租、离地铁近、免物业费等特色,除此之外,房间内还有热水器、微波炉、冰箱、洗衣机、床垫、桌子、空调、智能锁、椅子、1.5米床,供您使用。此外房源周边配套设施也为您的生活出行提供便利。目前房源已经通过空气检测</div>
        ...
        <div class="Z_isection mt60 scrollid" id="areacheck">
            ...
            <div class="Z_info_body">
                <ul class="jiance">
                    ...
                    <li><span class="info_label">检测报告</span>  <a class="info_value_active text_underline" alt="房屋空气质量检测报告" title="房屋空气质量检测报告" href="https://special.ziroom.com/2018/air_test_report/index.html?code=K8-LbLwH7JGkmXH19-SxxGj4CYKl2DO44bz6mlt9Bwg" target="_blank" >房屋空气质量检测报告</a></li>
                </ul>
            </div>
        </div>
        <div class="Z_isection mt60 scrollid" id="rentinfo">
            ...
            <div class="Z_info_body">
                <ul class="jiance">
                    ...
                    <li><span class="info_label">签约时长</span> <span class="info_value">可短租3-6个月 | 可长租1年</span></li>
                </ul>
            </div>
        </div>
            ...
            <div class="Z_info_body">
                <ul class="rent_list clearfix">
                    <li class="rented clearfix">
                        ...
                        <div class="info">
                            <p class="person"><span class="housename">02卧</span> <span class="time">入住6个月</span> </p>
                            <p class="person mt10"><span>女</span>
                                <i class="i"></i><span>白羊座</span>
                                <i class="i"></i><span>贸易进出口</span>
                            </p>
                        </div>
                    </li>
                    <li class="rented clearfix">
                        ...
                        <div class="info">
                            <p class="person"><span class="housename">03卧</span> <span class="time">入住7个月</span> </p>
                            <p class="person mt10"><span>女</span>
                                <i class="i"></i><span>处女座</span>
                                <i class="i"></i><span>运营/编辑</span>
                            </p>
                        </div>
                    </li>
                    <li class="rented clearfix">
                        ...
                        <div class="info">
                            <p class="person"><span class="housename">05卧</span> <span class="time">入住9个月</span> </p>
                            <p class="person mt10"><span>男</span>
                                <i class="i"></i><span>处女座</span>
                                <i class="i"></i><span>未知</span>
                            </p>
                        </div>
                    </li>
        ...
        <div class="Z_isection mt60 scrollid" id="villageinfo">
            <h2 class="Z_info_title mb20">小区简介</h2>
            <div class="Z_info_body">
                <div class="Z_village clearfix">
                    <div class="Z_village_img">
                        <img src="//img.ziroom.com/mona/g2/M00/93/13/ChAFfVte3S6AGBUgAAII9Lw0f-s180.jpg_C_800_600_Q100.jpg" alt="">
                    </div>
                    <div class="Z_village_info">
                        <h3>万科天誉二期</h3>
                        <ul class="Z_village_info_body">
                            <li><span class="label">建筑类型</span> <span class="value">塔板结合</span></li>
                            <li><span class="label">绿化率</span> <span class="value">30%</span></li>
                            <li><span class="label">容积率</span> <span class="value">6.3</span></li>
                            <li><span class="label">物业公司</span> <span class="value">深圳市万科物业管理有限公司</span></li>
                            <li><span class="label">物业电话</span> <span class="value">0755-43225831</span></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <aside class="Z_info_aside" >
        <h1 class="Z_name"><i class="status iconicon_sign"></i>万科天誉二期·4居室-01卧</h1>
        <div class="Z_price">
            <span>￥</span>
            <i class="num" style="background-position:-124.96px;background-image: url(//static8.ziroom.com/phoenix/pc/images/2019/price/486ff52ed774dbecf6f24855851e3704.png);" ></i>
            <i class="num" style="background-position:-31.24px;background-image: url(//static8.ziroom.com/phoenix/pc/images/2019/price/486ff52ed774dbecf6f24855851e3704.png);" ></i>
            <i class="num" style="background-position:-187.44px;background-image: url(//static8.ziroom.com/phoenix/pc/images/2019/price/486ff52ed774dbecf6f24855851e3704.png);" ></i>
            <i class="num" style="background-position:-93.72px;background-image: url(//static8.ziroom.com/phoenix/pc/images/2019/price/486ff52ed774dbecf6f24855851e3704.png);" ></i>
            <span>/月（季付价）</span>
        </div>
        ...
        <div class="Z_tags">
            <span class="tag">拿铁4.0</span>																<span class="tag">独立卫生间</span>																<span class="tag">短租</span>																<span class="tag">智能锁</span>																<span class="tag">非首次出租</span>																<span class="tag">离地铁近</span>																<span class="tag">免物业费</span>
        </div>
        <div class="Z_home_info">
            ...
            <ul class="Z_home_o">
                <li>
                    <span class="la">位置</span><span class="va">小区距3号线(龙岗线)吉祥站步行约125米</span>
                </li>
                <li>
                    <span class="la">楼层</span><span class="va">4/42</span>
                </li>
                <li>
                    <span class="la">电梯</span><span class="va">有</span>
                </li>
                <li>
                    <span class="la">年代</span><span class="va">暂无数据</span>
                </li>
                <li>
...
<div class="Z_container Z_bread mt60">
    <a href="//sz.ziroom.com/z/">深圳租房</a> / <a href="//sz.ziroom.com/z/d23008676-b612400030/">龙岗区区龙岗中心城</a>  / <span class="current">万科天誉二期合租</span>
