...
<head>
    ...
    <title>布吉德兴城花园朝南次卧合租租房价格信息_深圳龙岗区租房价格信息-如美家</title>
...
<section class="Z_container Z_main">
    ...
    <section class="Z_info_main">
            ...
            <div class="Z_sliders">
                ...
                <ul>
                    ...
                    <li class="Z_slider" data-type="image" data-t="图片">
                        <img src="images/img1/house1.1.jpg"alt="布吉德兴城花园合租房源" >
                    </li>
                    <li class="Z_slider" data-type="image" data-t="图片">
                        <img src="images/img1/house1.2.jpg"alt="布吉德兴城花园合租房源" >
                    </li>

                    <li class="Z_slider" data-type="image" data-t="图片">
                        <img src="images/img1/house1.3.jpg" alt="布吉德兴城花园合租房源" >
                    </li>
                    <li class="Z_slider" data-type="image" data-t="图片">
                        <img src="images/img1/house1.4.jpg" alt="布吉德兴城花园合租房源" >
                    </li>
                    <li class="Z_slider" data-type="image" data-t="图片">
                        <img src="images/img1/house1.5.jpg" alt="布吉德兴城花园合租房源" >
                    </li>

                    <li class="Z_slider" data-type="image" data-t="户型">
                        <img src="images/img1/house1.6.jpg" alt="布吉德兴城花园合租房源户型图" >
                    </li>
                </ul>
            ...
            <div class="Z_swiper_thumb">
                ...
                <ul class="Z_swiper_thumb_inner Z_sliders_nav">
                    ...
                    <li class="" data-index="1">
                        <img src="images/img1/house1.1.jpg">
                    </li>
                    <li class="" data-index="2">
                        <img src="images/img1/house1.2.jpg">
                    </li>

                    <li class="" data-index="3">
                        <img src="images/img1/house1.3.jpg">
                    </li>
                    <li class="" data-index="4">
                        <img src="images/img1/house1.4.jpg">
                    </li>
                    <li class="" data-index="5">
                        <img src="images/img1/house1.5.jpg">
                    </li>


                    <li class="" data-index="6">
                        <img src="images/img1/house1.6.jpg">
                    </li>
                </ul>
        ...
        <div class="Z_isection scrollid" id="homedesc">
            ...
            <div class="Z_rent_desc">
                该房源为主卧，带明窗，房屋采光比较好，业主用心维护，配置自如家电家私，搭配年轻舒适的装修风格，为您打造温馨舒适的居住环境，适合附近热爱生活的年轻白领或情侣入住                </div>
            <div class="hidehomedesc">房源位于深圳龙岗区布吉德兴城花园,房源户型为4室1厅, 共有4个房间。当前房间可入住时间为随时入住,此房间拥有布丁4.0、独立阳台、智能锁、首次出租、离地铁近、免物业费等特色,除此之外,房间内还有智能锁、桌子、路由器、椅子、洗衣机、油烟机、微波炉、嵌入式燃气灶、冰箱、热水器、推拉门衣柜、床垫、1.5米床、空调,供您使用。此外房源周边配套设施也为您的生活出行提供便利。目前房源已经通过空气检测且已超过30天,请您放心入住。</div>
            ...
            <div class="Z_info_body">
                <div class="Z_village clearfix">
                    <div class="Z_village_img">
                        <img src="http://img.ljcdn.com/hdic-resblock/m_fill,w_800,l_ziroom,lg_south_east,lx_-0.0625w,ly_-0.0625w,q_50/3693fa98-6fbe-40b5-b0a9-c73fdf0db193.jpg" alt="">
                    </div>
                    <div class="Z_village_info">
                        <h3>德兴城花园</h3>
                        <ul class="Z_village_info_body">
                            <li><span class="label">建筑年代</span> <span class="value">1999</span></li>
                            <li><span class="label">建筑类型</span> <span class="value">塔板结合</span></li>
                            <li><span class="label">绿化率</span> <span class="value">30%</span></li>
                            <li><span class="label">容积率</span> <span class="value">3.08</span></li>
                            <li><span class="label">物业公司</span> <span class="value">深圳市德美物业管理有限公司</span></li>
                            <li><span class="label">物业电话</span> <span class="value">无</span></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <aside class="Z_info_aside" >
        <h1 class="Z_name"><i class="status iconicon_sign"></i>德兴城花园·4居室-05卧</h1>
        <div class="Z_price">
            <span>￥</span>
        ...
        <div class="Z_home_info">
            ...
            <ul class="Z_home_o">
                <li>
                    <span class="la">位置</span><span class="va">小区距5号线(环中线)长龙站步行约127米</span>
                </li>
                <li>
                    <span class="la">楼层</span><span class="va">6/8</span>
                </li>
                <li>
                    <span class="la">电梯</span><span class="va">无</span>
                </li>
                <li>
...
<div class="Z_container Z_bread mt60">
    <a href="//sz.ziroom.com/z/">深圳租房</a> / <a href="//sz.ziroom.com/z/d23008676-b612400028/">龙岗区区布吉</a>  / <span class="current">德兴城花园合租</span>
