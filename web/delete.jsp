        ...
        <div class="house-item clearfix" id="house1">
            ...
            <div class="item-info fl">
                <h4 class="house-title">
                    ...
                    <span class="out" style="display: none;height: 29px;width: 80px;text-align: center;background-color: red;color: #fff;">已售罄</span>
                </h4>
                <p class="house-name">
            ...
            <div class="item-pricearea fr">
                ...
                <input type="button" value="取消出租" class="sold"  style="cursor: pointer; height: 36px; width: 200px; text-align: center;margin-top: 10px;background-color: orange;font-size: 23px;border-radius: 5px;">
            </div>
            <div class="clear"></div>
        </div>
