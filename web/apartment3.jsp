...
<section class="Z_container Z_main">
    ...
    <section class="Z_info_main">
            ...
            <div class="Z_sliders">
                ...
                <ul>
                    ...
                    <li class="Z_slider" data-type="image" data-t="图片">
                        <img src="images/img1/apart3.1.jpg"alt="长寿路拾光自如寓" >
                    </li>
                    <li class="Z_slider" data-type="image" data-t="图片">
                        <img src="images/img1/apart3.2.jpg"alt="长寿路拾光自如寓" >
                    </li>

                    <li class="Z_slider" data-type="image" data-t="图片">
                        <img src="images/img1/apart3.3.jpg" alt="长寿路拾光自如寓" >
                    </li>
                    <li class="Z_slider" data-type="image" data-t="图片">
                        <img src="images/img1/apart3.4.jpg" alt="长寿路拾光自如寓" >
                    </li>
                    <li class="Z_slider" data-type="image" data-t="图片">
                        <img src="images/img1/apart3.5.jpg" alt="长寿路拾光自如寓" >
                    </li>
                    <li class="Z_slider" data-type="image" data-t="图片">
                        <img src="images/img1/apart3.6.jpg" alt="长寿路拾光自如寓" >
                    </li>
                </ul>
            ...
            <div class="Z_swiper_thumb">
                ...
                <ul class="Z_swiper_thumb_inner Z_sliders_nav">
                    ...
                    <li class="" data-index="1">
                        <img src="images/img1/apart3.1.jpg">
                    </li>
                    <li class="" data-index="2">
                        <img src="images/img1/apart3.2.jpg">
                    </li>

                    <li class="" data-index="3">
                        <img src="images/img1/apart3.3.jpg">
                    </li>
                    <li class="" data-index="4">
                        <img src="images/img1/apart3.4.jpg">
                    </li>
                    <li class="" data-index="5">
                        <img src="images/img1/apart3.5.jpg">
                    </li>
                    <li class="" data-index="6">
                        <img src="images/img1/apart3.6.jpg">
                    </li>
                </ul>
        ...
        <div class="Z_isection scrollid" id="homedesc">
            ...
            <div class="Z_rent_desc">
                结合现有条件，充分利用户型内的空间，此户型内部分为三个区域，洗漱区、活动区、睡眠区。活动区配备写字桌、沙发和电视，约3平米的卫生间满足了所有的洗漱需求，睡眠区精选床垫舒适你的睡眠。
            </div>
    ...
    <aside class="Z_info_aside" >
        <h1 class="Z_name"><i class="status iconicon_sign"></i>拾光公寓·拾影开间</h1>
        <div class="Z_price">
            <span>￥</span>
        ...
        <div class="Z_home_info">
            ...
            <ul class="Z_home_o">
                <li>
                    <span class="la">位置</span><span class="va">上海市普陀区长寿路393号-8F</span>
                </li>
                <li>
...
<div class="Z_container Z_bread mt60">
    <a href="//sz.ziroom.com/z/">上海租房</a> / <a href="//sz.ziroom.com/z/d23008676-b612400028/">普陀区长寿路</a>  / <span class="current">拾光公寓</span>
