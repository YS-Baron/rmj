...
<head>
    ...
    <title>龙华公寓·一居loft仲夏套间  -如美家</title>
...
<section class="Z_container Z_main">
    ...
    <section class="Z_info_main">
            ...
            <div class="Z_sliders">
                ...
                <ul>
                    ...
                    <li class="Z_slider" data-type="image" data-t="图片">
                        <img src="images/img1/apart4.1.jpg"alt="龙华公寓" >
                    </li>
                    <li class="Z_slider" data-type="image" data-t="图片">
                        <img src="images/img1/apart4.2.jpg"alt="龙华公寓" >
                    </li>

                    <li class="Z_slider" data-type="image" data-t="图片">
                        <img src="images/img1/apart4.3.jpg" alt="龙华公寓" >
                    </li>
                    <li class="Z_slider" data-type="image" data-t="图片">
                        <img src="images/img1/apart4.4.jpg" alt="龙华公寓" >
                    </li>
                    <li class="Z_slider" data-type="image" data-t="图片">
                        <img src="images/img1/apart4.5.jpg" alt="龙华公寓" >
                    </li>
                    <li class="Z_slider" data-type="image" data-t="图片">
                        <img src="images/img1/apart4.6.jpg" alt="龙华公寓" >
                    </li>
                </ul>
            ...
            <div class="Z_swiper_thumb">
                ...
                <ul class="Z_swiper_thumb_inner Z_sliders_nav">
                    ...
                    <li class="" data-index="1">
                        <img src="images/img1/apart4.1.jpg">
                    </li>
                    <li class="" data-index="2">
                        <img src="images/img1/apart4.2.jpg">
                    </li>

                    <li class="" data-index="3">
                        <img src="images/img1/apart4.3.jpg">
                    </li>
                    <li class="" data-index="4">
                        <img src="images/img1/apart4.4.jpg">
                    </li>
                    <li class="" data-index="5">
                        <img src="images/img1/apart4.5.jpg">
                    </li>
                    <li class="" data-index="6">
                        <img src="images/img1/apart4.6.jpg">
                    </li>
                </ul>
        ...
        <div class="Z_isection scrollid" id="homedesc">
            ...
            <div class="Z_rent_desc">
                一居Loft户型，上层卧室，下层餐厅。无论是一人独住和两人 同住，都可满足双方需求。独立厨房，开启精致生活。超大落地明窗，生活阳台，视野开阔，风景尽收眼底。墙面以白蓝色为主题色，一同感受仲夏之梦。
            </div>
    ...
    <aside class="Z_info_aside" >
        <h1 class="Z_name"><i class="status iconicon_sign"></i>龙华公寓·一居loft仲夏套间 </h1>
        <div class="Z_price">
            <span>￥</span>
        ...
        <div class="Z_home_info">
            ...
            <ul class="Z_home_o">
                <li>
                    <span class="la">位置</span><span class="va">深圳市龙华新区民塘路与建设路交叉口尚峻花园一期3栋</span>
                </li>
                <li>
...
<div class="Z_container Z_bread mt60">
    <a href="//sz.ziroom.com/z/">深圳租房</a> / <a href="//sz.ziroom.com/z/d23008676-b612400028/">龙华新区民塘路与建设路交叉口</a>  / <span class="current">龙华公寓</span>
